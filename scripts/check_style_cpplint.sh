...
sherpa_mlx_dir=$(cd $cur_dir/.. && pwd)

build_dir=$sherpa_mlx_dir/build
mkdir -p $build_dir
...
source $sherpa_mlx_dir/scripts/utils.sh
...
function do_check() {
  case "$1" in
    ...
    2)
      ...
      files=$(find $sherpa_mlx_dir/cxx-api-examples $sherpa_mlx_dir/c-api-examples $sherpa_mlx_dir/sherpa-mlx/csrc $sherpa_mlx_dir/sherpa-mlx/python $sherpa_mlx_dir/scripts/node-addon-api/src $sherpa_mlx_dir/sherpa-mlx/jni $sherpa_mlx_dir/sherpa-mlx/c-api -name "*.h" -o -name "*.cc")
      files2=$(find $sherpa_mlx_dir/harmony-os/SherpamlxHar/sherpa_mlx/src/main/cpp/ -name "*.cc")
      ;;
    *)
