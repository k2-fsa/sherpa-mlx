// sherpa-mlx/csrc/text-utils.h
//
// Copyright 2009-2011  Saarland University;  Microsoft Corporation
// Copyright      2023  Xiaomi Corporation
#ifndef SHERPA_MLX_CSRC_TEXT_UTILS_H_
#define SHERPA_MLX_CSRC_TEXT_UTILS_H_
#include <errno.h>
#include <stdlib.h>
...
bool ConvertStringToInteger(const std::string &str, Int *out) {
  ...
  char *end = nullptr;
  errno = 0;
  int64_t i = SHERPA_MLX_STRTOLL(this_str, &end);
  if (end != this_str) {
...
#endif  // SHERPA_MLX_CSRC_TEXT_UTILS_H_
